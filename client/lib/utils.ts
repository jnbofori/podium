...
import type { PodiumJobMetadata } from '@/lib/podium';
 ...
 * @param appConfig - The app configuration
 * @param getMetadata - Optional getter for Podium job metadata at fetch time
 * @returns A token source for a sandboxed LiveKit session
 */
export function getSandboxTokenSource(
  appConfig: AppConfig,
  getMetadata?: () => PodiumJobMetadata | null
) {
